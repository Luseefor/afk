...
PROFILES = {
    "development": {
        ...
        "breaker": CircuitBreakerPolicy(failure_threshold=8, cooldown_s=10.0, half_open_max_calls=2),
    ...
    "production": {
        ...
        "breaker": CircuitBreakerPolicy(failure_threshold=5, cooldown_s=30.0, half_open_max_calls=1),
        "hedging": HedgingPolicy(enabled=False, delay_s=0.2),
    ...
    "high_throughput": {
        ...
        "breaker": CircuitBreakerPolicy(failure_threshold=10, cooldown_s=20.0, half_open_max_calls=3),
        "hedging": HedgingPolicy(enabled=False, delay_s=0.2),
    ...
    "low_latency": {
        ...
        "breaker": CircuitBreakerPolicy(failure_threshold=3, cooldown_s=15.0, half_open_max_calls=1),
