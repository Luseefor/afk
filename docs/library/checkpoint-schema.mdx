...
description: Checkpoint data model, lifecycle phases, resume semantics, and corruption safeguards.
---
...
- [afk/agents/versioning.py](https://github.com/socioy/afk/blob/main/src/afk/agents/versioning.py)
