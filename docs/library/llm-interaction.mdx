...
description: Detailed LLM request lifecycle, retries, structured output flow, and runtime contracts.
---
...
- Runner resolves agent instructions before first call (inline or file-backed system prompt loader).
...
- [afk/llms/factory.py](https://github.com/socioy/afk/blob/main/src/afk/llms/factory.py)
- [afk/agents/resolution.py](https://github.com/socioy/afk/blob/main/src/afk/agents/resolution.py)
- [afk/agents/prompt_store.py](https://github.com/socioy/afk/blob/main/src/afk/agents/prompt_store.py)

## Required Capabilities

- explicit adapter/model resolution strategy
- retry/timeout settings tuned for workload latency budgets
- fallback model chain for provider instability
- structured-output validation handling for strict response contracts
...
1. [Failure Policies](/library/failure-policy-matrix)
