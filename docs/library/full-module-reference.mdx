---
title: AFK Full Module Reference
...
- Prefer [API Reference](./api-reference) for human-guided explanations.
- Prefer [Developer Onboarding Guide](./developer-guide) for first-time setup and workflows.
