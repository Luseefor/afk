---
title: Security
description: Tool trust boundaries, sandbox enforcement, and output sanitization behavior in AFK.
---
...
- [afk/agents/security/**init**.py](https://github.com/socioy/afk/blob/main/src/afk/agents/security/__init__.py)
...
- sanitization enabled for untrusted tool output
- strict sandbox profile defaults for network/command/path controls
- policy gates for side-effecting or high-risk tools
- secret scope strategy for controlled secret propagation
