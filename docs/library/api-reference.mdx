...
- For first-time onboarding, start with [Developer Onboarding Guide](./developer-guide).
- For complete symbol-level internal map, use [Full Module Reference](./full-module-reference).
...
- [Developer Onboarding Guide](./developer-guide)
- [Examples Runbook](./examples/index)
- [Architecture](./architecture)
- [Public Imports and Function Improvement](./public-imports-and-function-improvement)
- [Full Module Reference (all source modules)](./full-module-reference)
- [Tested Behaviors and Edge Cases](./tested-behaviors)
- [Tool Call Lifecycle](./tool-call-lifecycle)
- [Tools System Walkthrough](./tools-system-walkthrough)
- [LLM Interaction Flow](./llm-interaction)
- [Agentic Behavior and Orchestration](./agentic-behavior)
- [Checkpoint and Resume Schema](./checkpoint-schema)
- [Run Event Contract](./run-event-contract)
- [Failure Policy Matrix](./failure-policy-matrix)
...
- [afk/agents/chat.py](../../src/afk/agents/chat.py)
...
- [afk/core/runner.py](../../src/afk/core/runner.py)
- [afk/core/runner_api.py](../../src/afk/core/runner_api.py)
...
- [afk/llms/config.py](../../src/afk/llms/config.py)
- [afk/llms/middleware.py](../../src/afk/llms/middleware.py)
...
- [afk/llms/clients/adapters/openai.py](../../src/afk/llms/clients/adapters/openai.py)
- [afk/llms/clients/adapters/litellm.py](../../src/afk/llms/clients/adapters/litellm.py)
- [afk/llms/clients/adapters/anthropic_agent.py](../../src/afk/llms/clients/adapters/anthropic_agent.py)
- [afk/llms/clients/base/responses.py](../../src/afk/llms/clients/base/responses.py)
...
- [afk/llms/observability.py](../../src/afk/llms/observability.py)
- [afk/llms/errors.py](../../src/afk/llms/errors.py)
...
- [afk/memory/models.py](../../src/afk/memory/models.py)
- [afk/memory/store/base.py](../../src/afk/memory/store/base.py)
- [afk/memory/store/in_memory.py](../../src/afk/memory/store/in_memory.py)
- [afk/memory/store/sqlite.py](../../src/afk/memory/store/sqlite.py)
- [afk/memory/store/redis.py](../../src/afk/memory/store/redis.py)
- [afk/memory/store/postgres.py](../../src/afk/memory/store/postgres.py)
- [afk/memory/factory.py](../../src/afk/memory/factory.py)
